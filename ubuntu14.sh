...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/MuluuJelekk/openvpn/master/squid.conf" 
MYIP=`ifconfig | grep -Eo 'inet (addr:)?([0-9]*\.){3}[0-9]*' | grep -Eo '([0-9]*\.){3}[0-9]*' | grep -v '127.0.0' | grep -v '192.168'`;
sed -i s/xxxxxxxxx/$MYIP/g /etc/squid3/squid.conf;
service squid3 restart

# Enable Firewall
sudo ufw allow 22,80,81,222,443,88,9700,60000/tcp
sudo ufw allow 22,80,81,222,443,88,9700,60000/udp
sudo yes | ufw enable
...
echo "-Vnstat"
echo "-Web Server"
echo "-Squid Proxy Port 88,60000"
echo "MuLuu09"
